...
// window.onload = function () {
//   // if local has saved artists
//   if (localStorage.getItem("savedArtists")) {
//     // grab it
//     searchHistory = JSON.parse(localStorage.getItem("savedArtists"));
//     console.log('saved artists found:', searchHistory) 

//     // loop through each saved artist in searchHistory
//     searchHistory.forEach(artist => {
//       // set searchRequest to current artist
...
searchBtn.addEventListener("click", function (event) {
  ...
  if (searchHistory.includes(searchRequest)) {
    ...
    // allow searchRequest to be found outside this function
...
function getArtist(data) {
  ...
  let cogsName = cogData.title;
  console.log("cogsData artist name: ", cogsName) // logs Nirvana!
